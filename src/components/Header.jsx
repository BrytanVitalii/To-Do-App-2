...
const Header = () => {
  return (
    <div className='standartBlock font-poppins w-11/12 h-24 mt-4 sm:mt-8 bg-gray-500 rounded-2xl shadow-2xl flex justify-between'>
        ...
        <div className='flex items-center gap-6 h-full p-3 sm:pr-6'>
            <a
              ...
              className="h-1/2 sm:h-2/3 cursor-pointer drop-shadow-md inline-block"
            >
